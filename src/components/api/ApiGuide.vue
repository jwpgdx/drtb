  ...
  <DialogContent class="max-w-md">
    ...
    <Tabs v-model="step" class="w-full">
      ...
      <TabsContent value="2">
        <div class="space-y-2">
          <img
            src="/images/BithumbApiGuide-2.png"
      ...
      <TabsContent value="3">
        <div class="space-y-2">
          <h3 class="text-lg font-semibold">3. IP 주소 등록</h3>
          <p>
      ...
      <TabsContent value="4">
        <img
          src="/images/BithumbApiGuide-4.png"
          alt="API Key 발급 데모 이미지"
          class="w-full h-auto"
        />
        <div class="space-y-2">
          ...
          <ul class="list-disc pl-5 space-y-1 text-sm text-gray-600 mt-2">
            <li>
              <strong class="text-red-600">Secret Key</strong>는 
              <strong class="text-red-600">최초 1회</strong>에 한해 발급되며 추가로 확인하실 수 없으니, 
              발급받으신 <strong class="text-red-600">Secret Key</strong>는 반드시 
              <span class="text-yellow-500 font-semibold">안전한 곳에 별도로 보관</span>하여 주시기 바랍니다. 
              <span role="img" aria-label="warning" class="text-red-500">⚠️</span>
            </li>
          </ul>
